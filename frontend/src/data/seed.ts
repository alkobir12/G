export interface Part { id: string; oem: string; name_ar: string; brand: string; category: string; model: string; stock: number; min_stock: number; location: string; cost: number; price: number; wholesale: number; supplier_id?: string; }
...
export const SEED_SUPPLIERS: Supplier[] = [
  ...
  { id: "SUP-104", name: "شركة القراوي - وكالة تويوتا", contact: "الفروة عماوي التجارية", phone: "1131037700", city: "الرياض", rating: 4.9, balance: 0 },
  { id: "SUP-105", name: "الوادي المشهور - Famous Valley", contact: "DHANESH", phone: "02-55536665", city: "أبو ظبي", rating: 4.7, balance: 0 },
];
...
export const ALQARAWI_PARTS: Part[] = [
  // Invoice #11631 (16/04/2025) - items 1-13
  { id: "SKU-AQ-0001", oem: "04111-50541", name_ar: "طقم وجه صالون 2008-2012 V8 بنزين", brand: "Toyota", category: "محرك", model: "LC200 V8 بنزين (1UR/3UR)", stock: 0, min_stock: 1, location: "C01-ممر1", cost: 2037, price: 3055, wholesale: 2546, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0002", oem: "11011-50010", name_ar: "هلالات كرنك صالون 98-2012 V8+لكزس430", brand: "Toyota", category: "محرك", model: "LC V6 بنزين (1FZ/1GR)", stock: 0, min_stock: 1, location: "C01-ممر2", cost: 153, price: 230, wholesale: 191, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0003", oem: "11071-50021-01", name_ar: "سيكاڤكايت صفر صالون 2008-2012 V8 ×3", brand: "Toyota", category: "محرك", model: "LC V6 بنزين (1FZ/1GR)", stock: 0, min_stock: 1, location: "C01-ممر3", cost: 98, price: 147, wholesale: 122, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0004", oem: "11701-50032-05", name_ar: "سيكاڤكايت صفر صالون 98-2010 V8 ×2", brand: "Toyota", category: "محرك", model: "LC V6 بنزين (1FZ/1GR)", stock: 0, min_stock: 1, location: "C01-ممر4", cost: 149, price: 224, wholesale: 186, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0005", oem: "12361-50250", name_ar: "كرسي مكينة يمين صالون 2008 V8 بنزين", brand: "Toyota", category: "محرك", model: "LC200 V8 بنزين (1UR/3UR)", stock: 0, min_stock: 1, location: "C02-ممر1", cost: 658, price: 987, wholesale: 822, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0006", oem: "12362-50030", name_ar: "كرسي مكينة يسار صالون 2008 V8 بنزين", brand: "Toyota", category: "محرك", model: "LC200 V8 بنزين (1UR/3UR)", stock: 0, min_stock: 1, location: "C02-ممر2", cost: 658, price: 987, wholesale: 822, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0007", oem: "13011-50162", name_ar: "شلير صفر صالون 2008-2012 V8 بنزين", brand: "Toyota", category: "محرك", model: "LC200 V8 بنزين (1UR/3UR)", stock: 0, min_stock: 1, location: "C02-ممر3", cost: 1926, price: 2889, wholesale: 2407, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0008", oem: "13041-50031-02", name_ar: "سيكاڤمتحرك صالون 98-2012 V8 ×8", brand: "Toyota", category: "محرك", model: "LC V6 بنزين (1FZ/1GR)", stock: 0, min_stock: 1, location: "C02-ممر4", cost: 87, price: 131, wholesale: 109, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0009", oem: "13101-50082-01", name_ar: "بستم صفر صالون 2008-2014 V8 بنزين ×4 (يمين)", brand: "Toyota", category: "محرك", model: "LC V6 بنزين (1FZ/1GR)", stock: 0, min_stock: 1, location: "C03-ممر1", cost: 317, price: 476, wholesale: 396, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0010", oem: "13301-50072-01", name_ar: "بستم صفر صالون 2008-2012 V8 بنزين ×4 (يسار)", brand: "Toyota", category: "محرك", model: "LC V6 بنزين (1FZ/1GR)", stock: 0, min_stock: 1, location: "C03-ممر2", cost: 317, price: 476, wholesale: 396, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0011", oem: "13503-50011", name_ar: "بكر ڤيرين صالون 98-2012 V8+لكزس430", brand: "Toyota", category: "محرك", model: "LC V6 بنزين (1FZ/1GR)", stock: 0, min_stock: 1, location: "C03-ممر3", cost: 321, price: 482, wholesale: 401, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0012", oem: "13505-50030", name_ar: "بكر يمين صالون 98-2012 V8+لكزس430", brand: "Toyota", category: "محرك", model: "LC V6 بنزين (1FZ/1GR)", stock: 0, min_stock: 1, location: "C03-ممر4", cost: 319, price: 479, wholesale: 399, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0013", oem: "13540-50030", name_ar: "فحمة جلزير صالون 98-2011 V8 بنزين", brand: "Toyota", category: "محرك", model: "LC V6 بنزين (1FZ/1GR)", stock: 0, min_stock: 1, location: "C04-ممر1", cost: 325, price: 488, wholesale: 406, supplier_id: "SUP-104" },
  // Invoice #11244 (10/04/2025) + #16988 (06/07/2025) — LC200 V8 ديزل + هاي كلوب ديزل
  { id: "SKU-AQ-0014", oem: "04111-51035", name_ar: "طقم وجه صالون 2008 ديزل", brand: "Toyota", category: "محرك", model: "LC200 V8 ديزل (1VD-FTV)", stock: 0, min_stock: 1, location: "C04-ممر2", cost: 1952, price: 2928, wholesale: 2440, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0015", oem: "11011-51010", name_ar: "هلالات كرنك V8 ديزل 2008", brand: "Toyota", category: "محرك", model: "Hiace/LC ديزل (1KD/1VD)", stock: 0, min_stock: 1, location: "C04-ممر3", cost: 181, price: 272, wholesale: 226, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0016", oem: "11071-51010-07", name_ar: "سيكاڤصفر (جوانة غطاء الرأس)", brand: "Toyota", category: "محرك", model: "Hiace/LC ديزل (1KD/1VD)", stock: 0, min_stock: 1, location: "C04-ممر4", cost: 98, price: 147, wholesale: 122, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0017", oem: "11115-51030-B0", name_ar: "وجه راس (جوانة رأس الأسطوانة)", brand: "Toyota", category: "محرك", model: "LC200 V8 ديزل (1VD-FTV)", stock: 0, min_stock: 1, location: "C05-ممر1", cost: 257, price: 386, wholesale: 321, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0018", oem: "11116-51030-D0", name_ar: "وجه راس يسار صالون 2008 ديزل", brand: "Toyota", category: "محرك", model: "LC200 V8 ديزل (1VD-FTV)", stock: 0, min_stock: 1, location: "C05-ممر2", cost: 257, price: 386, wholesale: 321, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0019", oem: "11122-30020", name_ar: "قلنديلوف هواونار هايس 2006 ديزل ×32", brand: "Toyota", category: "كهرباء", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "C05-ممر3", cost: 49, price: 74, wholesale: 61, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0020", oem: "11701-51020-07", name_ar: "سيكاڤكايت (مانع تسرب ساق الصمام)", brand: "Toyota", category: "محرك", model: "Hiace/LC ديزل (1KD/1VD)", stock: 0, min_stock: 1, location: "C05-ممر4", cost: 81, price: 122, wholesale: 101, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0021", oem: "12361-51030", name_ar: "كرسي مكينة يمين صالون 2008 ديزل", brand: "Toyota", category: "محرك", model: "Hiace/LC ديزل (1KD/1VD)", stock: 0, min_stock: 1, location: "C06-ممر1", cost: 571, price: 857, wholesale: 714, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0022", oem: "12362-51010", name_ar: "كرسي مكينة يسار صالون 2008 ديزل", brand: "Toyota", category: "محرك", model: "Hiace/LC ديزل (1KD/1VD)", stock: 0, min_stock: 1, location: "C06-ممر2", cost: 571, price: 857, wholesale: 714, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0023", oem: "13011-51040", name_ar: "شلير صفر صالون 2008 V8 ديزل", brand: "Toyota", category: "محرك", model: "LC200 V8 ديزل (1VD-FTV)", stock: 0, min_stock: 1, location: "C06-ممر3", cost: 1991, price: 2987, wholesale: 2489, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0024", oem: "13041-51021-03", name_ar: "سيكاڤمتحرك صفر (حلقات مكبس) ×8", brand: "Toyota", category: "محرك", model: "Hiace/LC ديزل (1KD/1VD)", stock: 0, min_stock: 1, location: "C06-ممر4", cost: 65, price: 98, wholesale: 81, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0025", oem: "13301-0W011-A0", name_ar: "بستم صفر صالون 2008 ديزل ×4 (يسار)", brand: "Toyota", category: "محرك", model: "Hiace/LC ديزل (1KD/1VD)", stock: 0, min_stock: 1, location: "C07-ممر1", cost: 396, price: 594, wholesale: 495, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0026", oem: "13101-0W021-A0", name_ar: "بستم صفر صالون 2008 ديزل ×4 (يمين)", brand: "Toyota", category: "محرك", model: "Hiace/LC ديزل (1KD/1VD)", stock: 0, min_stock: 1, location: "C07-ممر2", cost: 396, price: 594, wholesale: 495, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0027", oem: "13711-51030", name_ar: "بلوف هواء (صمام سحب) صالون 2008 V8 ديزل ×16", brand: "Toyota", category: "تبريد", model: "Hiace/LC ديزل (1KD/2KD/1VD)", stock: 0, min_stock: 1, location: "C07-ممر3", cost: 89, price: 134, wholesale: 111, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0028", oem: "13715-51030", name_ar: "بلوف نار (شمعة توهج) صالون 2008 V8 ديزل ×16", brand: "Toyota", category: "تبريد", model: "Hiace/LC ديزل (1KD/2KD/1VD)", stock: 0, min_stock: 1, location: "C07-ممر4", cost: 122, price: 183, wholesale: 152, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0029", oem: "15100-51021", name_ar: "طرمبة ريت (مضخة زيت) صالون 2008 V8 ديزل", brand: "Toyota", category: "تبريد", model: "Hiace/LC ديزل (1KD/1VD)", stock: 0, min_stock: 1, location: "C08-ممر1", cost: 568, price: 852, wholesale: 710, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0030", oem: "151A0-51020", name_ar: "طرمبة ريت تيربو صالون 2008 V8 ديزل", brand: "Toyota", category: "تبريد", model: "LC200 V8 ديزل (1VD-FTV)", stock: 0, min_stock: 1, location: "C08-ممر2", cost: 1289, price: 1934, wholesale: 1611, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0031", oem: "16100-59366", name_ar: "طرمبة ماء صالون 2008-2017 V8 ديزل", brand: "Toyota", category: "تبريد", model: "Hiace/LC ديزل (1KD/1VD)", stock: 0, min_stock: 1, location: "C08-ممر3", cost: 787, price: 1181, wholesale: 984, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0032", oem: "16307-51011", name_ar: "قاعدة طرمبة ماء صالون 2008 V8 ديزل", brand: "Toyota", category: "تبريد", model: "Hiace/LC ديزل (1KD/1VD)", stock: 0, min_stock: 1, location: "C08-ممر4", cost: 566, price: 849, wholesale: 707, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0033", oem: "31230-60260", name_ar: "فحمة كلتش صالون 2008 ديزل", brand: "Toyota", category: "فرامل", model: "Hiace/LC ديزل (1KD/1VD)", stock: 0, min_stock: 1, location: "C09-ممر1", cost: 459, price: 689, wholesale: 574, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0034", oem: "90363-15017", name_ar: "رمان حذاف جيب ديزل 90-97 (4500)", brand: "Toyota", category: "عليق", model: "LC80/100 V8 ديزل (1FZ/1HZ)", stock: 0, min_stock: 1, location: "C09-ممر2", cost: 122, price: 183, wholesale: 152, supplier_id: "SUP-104" },
  // Invoice #11631 (16/04/2025) items 14-20 - V6 PETROL
  { id: "SKU-AQ-0035", oem: "13568-59095", name_ar: "سير تيمن صالون 98-2012 V8+لكزس470", brand: "Toyota", category: "محرك", model: "LC V6 بنزين (1FZ/1GR)", stock: 0, min_stock: 1, location: "C09-ممر3", cost: 482, price: 723, wholesale: 602, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0036", oem: "16100-59276", name_ar: "طرمبة ماء صالون 98-2011 V8+لكزس430", brand: "Toyota", category: "تبريد", model: "LC V6 بنزين (1FZ/1GR)", stock: 0, min_stock: 1, location: "C09-ممر4", cost: 891, price: 1337, wholesale: 1114, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0037", oem: "90311-38083", name_ar: "صوفاڤور (أوريينج) علبة جير اتوماتيك", brand: "Toyota", category: "محرك", model: "Toyota عام", stock: 0, min_stock: 1, location: "C10-ممر1", cost: 33, price: 50, wholesale: 41, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0038", oem: "90915-YZZD4", name_ar: "سيڤون زيت جيب V6/8 بنزين", brand: "Toyota", category: "محرك", model: "LC V6 بنزين (1FZ/1GR)", stock: 0, min_stock: 1, location: "C10-ممر2", cost: 27.50, price: 41, wholesale: 34, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0039", oem: "90916-03100", name_ar: "بلف حرارة صالون 98-2012 V8+لكزس", brand: "Toyota", category: "تبريد", model: "LC V6 بنزين (1FZ/1GR)", stock: 0, min_stock: 1, location: "C10-ممر3", cost: 100, price: 150, wholesale: 125, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0040", oem: "90919-01210", name_ar: "بواجي (شمعات إشعال) راف4+لكروزر+لكزس 2001", brand: "Toyota", category: "كهرباء", model: "LC/Lexus V8 بنزين", stock: 0, min_stock: 1, location: "C10-ممر4", cost: 60, price: 90, wholesale: 75, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0041", oem: "99981-TGM02-SL", name_ar: "زيت تويوتا 20W-50 أصلي", brand: "Toyota", category: "زيوت", model: "Toyota عام", stock: 0, min_stock: 5, location: "C11-ممر1", cost: 20.19, price: 30, wholesale: 25, supplier_id: "SUP-104" },

  // ═══════════════════════════════════════════════════
  // ALQARAWI HIACE PARTS (from structured data file)
  // ═══════════════════════════════════════════════════
  // Hiace 2020 Diesel — Invoice #4688
  { id: "SKU-AQ-0043", oem: "13559-11010", name_ar: "شداد جلزير هايس 2020 ديزل", brand: "Toyota", category: "محرك", model: "Hiace KDH2020 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D01-43", cost: 131.0, price: 196.5, wholesale: 170.3, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0044", oem: "13559-11020", name_ar: "شداد جلزير هايس 2020 ديزل", brand: "Toyota", category: "محرك", model: "Hiace KDH2020 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D01-44", cost: 131.0, price: 196.5, wholesale: 170.3, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0045", oem: "13561-0E011", name_ar: "شداد جلزير", brand: "Toyota", category: "محرك", model: "Hiace KDH2020 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D01-45", cost: 103.0, price: 154.5, wholesale: 133.9, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0046", oem: "13582-11010", name_ar: "شداد جلزير هايس 2020 ديزل", brand: "Toyota", category: "محرك", model: "Hiace KDH2020 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D01-46", cost: 124.0, price: 186.0, wholesale: 161.2, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0047", oem: "13711-11030", name_ar: "وزنة مثبت التايمن", brand: "Toyota", category: "عام", model: "Hiace KDH2020 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D01-47", cost: 26.0, price: 39.0, wholesale: 33.8, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0048", oem: "13715-11050", name_ar: "بلف (صمام)", brand: "Toyota", category: "محرك", model: "Hiace KDH2020 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D01-48", cost: 72.0, price: 108.0, wholesale: 93.6, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0049", oem: "16100-19365", name_ar: "بلف (صمام)", brand: "Toyota", category: "محرك", model: "Hiace KDH2020 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D01-49", cost: 109.0, price: 163.5, wholesale: 141.7, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0050", oem: "17801-0L040", name_ar: "طرمبة ماء", brand: "Toyota", category: "تبريد", model: "Hiace KDH2020 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D01-50", cost: 597.0, price: 895.5, wholesale: 776.1, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0051", oem: "90916-03118", name_ar: "فلتر هواء هايس 2016 بنزين+ديزل", brand: "Toyota", category: "زيوت", model: "Hiace KDH2020 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D01-51", cost: 195.0, price: 292.5, wholesale: 253.5, supplier_id: "SUP-104" },
  // Hiace 2006 Diesel — Invoice #10943
  { id: "SKU-AQ-0052", oem: "04111-30579", name_ar: "طقم وجه هايس 2006 ديزل", brand: "Toyota", category: "محرك", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-52", cost: 1138.0, price: 1707.0, wholesale: 1479.4, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0053", oem: "11011-30010", name_ar: "هلالات كرنك هايس 2006-2016 ديزل", brand: "Toyota", category: "محرك", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-53", cost: 181.0, price: 271.5, wholesale: 235.3, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0054", oem: "11115-30041-A0", name_ar: "وجه راس (جوانة رأس الأسطوانة) هايس 2018 ديزل", brand: "Toyota", category: "محرك", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-54", cost: 338.0, price: 507.0, wholesale: 439.4, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0055", oem: "11701-30020-02", name_ar: "سيكاڤايات هايس 2006-2016 ديزل ×5", brand: "Toyota", category: "عام", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-55", cost: 120.0, price: 180.0, wholesale: 156.0, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0056", oem: "12361-0L030", name_ar: "كرسي مكينة هايس 2006-2020 ديزل", brand: "Toyota", category: "محرك", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-56", cost: 239.0, price: 358.5, wholesale: 310.7, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0057", oem: "13011-30061", name_ar: "شلير صفر هايس 2006 ديزل", brand: "Toyota", category: "محرك", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-57", cost: 773.0, price: 1159.5, wholesale: 1004.9, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0058", oem: "13041-30020-02", name_ar: "سيكاڤمتحرك صفر هايس 2006-2016 ديزل ×4", brand: "Toyota", category: "عام", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-58", cost: 94.0, price: 141.0, wholesale: 122.2, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0059", oem: "13101-30081-01", name_ar: "بستم صفر هايس 2006 ديزل ×4", brand: "Toyota", category: "محرك", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-59", cost: 615.0, price: 922.5, wholesale: 799.5, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0060", oem: "13505-67042", name_ar: "بكر ڤيرين هايس 2006-2016 ديزل", brand: "Toyota", category: "عام", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-60", cost: 405.0, price: 607.5, wholesale: 526.5, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0061", oem: "13568-09131", name_ar: "سير تيمن هايس 2006-2018 ديزل", brand: "Toyota", category: "محرك", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-61", cost: 299.0, price: 448.5, wholesale: 388.7, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0062", oem: "16100-09261", name_ar: "طرمبة ماء هايس 2006-2016 ديزل", brand: "Toyota", category: "تبريد", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-62", cost: 597.0, price: 895.5, wholesale: 776.1, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0063", oem: "16210-30031", name_ar: "اتوماتيك مروحة هايس 2006 ديزل", brand: "Toyota", category: "تبريد", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-63", cost: 1029.0, price: 1543.5, wholesale: 1337.7, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0064", oem: "31210-0K023", name_ar: "دمبك هايس 2006 ديزل", brand: "Toyota", category: "فرامل", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-64", cost: 1296.0, price: 1944.0, wholesale: 1684.8, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0065", oem: "31230-71030", name_ar: "قعبة كلتش هايس 2006 ديزل", brand: "Toyota", category: "فرامل", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-65", cost: 382.0, price: 573.0, wholesale: 496.6, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0066", oem: "31250-0K210", name_ar: "اصبع كلتش هايس 2006 ديزل", brand: "Toyota", category: "فرامل", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-66", cost: 678.0, price: 1017.0, wholesale: 881.4, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0067", oem: "90363-12024", name_ar: "ارمان حذاف", brand: "Toyota", category: "عليق", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-67", cost: 29.0, price: 43.5, wholesale: 37.7, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0068", oem: "90916-03118", name_ar: "بلف حرارة هايس 2006 ديزل", brand: "Toyota", category: "تبريد", model: "Hiace KDH200 ديزل (1KD/2KD)", stock: 0, min_stock: 1, location: "D02-68", cost: 100.0, price: 150.0, wholesale: 130.0, supplier_id: "SUP-104" },
  // ═══ Missing OEMs from data file (corrected 2026-05-25) ═══
  { id: "SKU-AQ-0069", oem: "11115-51030-A0", name_ar: "وجه راس يمين صالون 2008-2017 V8 ديزل", brand: "Toyota", category: "محرك", model: "LC200 V8 ديزل (1VD-FTV)", stock: 0, min_stock: 1, location: "C05-69", cost: 257, price: 386, wholesale: 321, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0070", oem: "11118-51030-A0", name_ar: "وجه راس يسار صالون 2008-2017 V8 ديزل", brand: "Toyota", category: "محرك", model: "LC200 V8 ديزل (1VD-FTV)", stock: 0, min_stock: 1, location: "C05-70", cost: 257, price: 386, wholesale: 321, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0071", oem: "13041-51021-05", name_ar: "سيكاڤمتحرك صفر (حلقات مكبس) V8 ديزل ×3", brand: "Toyota", category: "محرك", model: "LC200 V8 ديزل (1VD-FTV)", stock: 0, min_stock: 1, location: "C06-71", cost: 65, price: 98, wholesale: 81, supplier_id: "SUP-104" },
  { id: "SKU-AQ-0072", oem: "90916-03089", name_ar: "بلف حرارة جيب+صالون 1990-2013 (مقاس 76)", brand: "Toyota", category: "تبريد", model: "Toyota/Lexus عام", stock: 0, min_stock: 1, location: "C11-72", cost: 100, price: 150, wholesale: 125, supplier_id: "SUP-104" },
];
